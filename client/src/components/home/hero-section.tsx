...
export default function HeroSection() {
  ...
  return (
    <div className="bg-gradient-to-b from-background to-muted relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -right-40 -top-40 w-80 h-80 rounded-full bg-primary/10 blur-3xl"></div>
        <div className="absolute left-0 top-1/2 w-full h-1/2 bg-gradient-to-t from-primary/5 to-transparent"></div>
        <div className="absolute left-1/3 top-1/3 w-48 h-48 rounded-full bg-accent/10 blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-16 md:py-24 px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div className={`text-center ${isRTL ? 'lg:text-right' : 'lg:text-left'} animate-fade-in`}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-cairo font-bold mb-6 leading-tight tracking-tight bg-gradient-to-r from-foreground to-foreground/60 bg-clip-text">
              {t("hero.title")}
            </h1>
            ...
            <div className="relative mb-10 max-w-lg mx-auto lg:mx-0">
              <div className="flex items-center shadow-lg rounded-full border border-input bg-card overflow-hidden">
          ...
          <div className="hidden lg:flex justify-center items-center relative animate-fade-in">
            ...
            <div className="relative bg-white p-4 rounded-2xl shadow-2xl rotate-1 hover:rotate-0 transition-transform duration-500 max-w-lg">
              ...
              {/* Floating cards */}
              <div className="absolute -bottom-8 -left-8 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-3 w-48 border border-border animate-slide-up" style={{ animationDelay: '0.3s' }}>
                <div className="flex items-center gap-2">
                  <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center">
                    <Briefcase className="h-4 w-4 text-primary" />
                  </div>
                  <div className="flex-1">
                    <p className="text-xs font-medium text-muted-foreground">{t("hero.projects")}</p>
                    <p className="text-sm font-bold">25,400+</p>
                  </div>
                </div>
              </div>
              
              <div className="absolute -top-10 -right-10 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-3 w-52 border border-border animate-slide-up" style={{ animationDelay: '0.5s' }}>
                <div className="flex items-center gap-2">
              ...
              <div className="absolute top-1/3 -right-12 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-3 w-44 border border-border animate-slide-up" style={{ animationDelay: '0.7s' }}>
                <div className="flex items-center gap-2">
                  <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center">
                    <Globe className="h-4 w-4 text-primary" />
                  </div>
                  <div className="flex-1">
                    <p className="text-xs font-medium text-muted-foreground">{t("hero.worldwide")}</p>
      ...
      <div className="border-t border-border w-full py-8 mt-8">
