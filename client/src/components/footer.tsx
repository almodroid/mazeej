...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-background to-muted pt-20 pb-12 border-t border-border relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -left-40 -bottom-40 w-80 h-80 rounded-full bg-primary/5 blur-3xl"></div>
        <div className="absolute right-0 bottom-0 w-72 h-72 rounded-full bg-accent/5 blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-6">
              <h4 className="font-cairo font-semibold mb-3 text-sm">{t("footer.getInTouch")}</h4>
            ...
            <div className={`flex ${isRTL ? 'space-x-0 space-x-reverse space-x-4' : 'space-x-4'}`}>
              <a 
                href="#" 
                className="w-9 h-9 rounded-full bg-primary/10 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors duration-200"
                aria-label="Twitter"
              >
          ...
          <div className="lg:col-span-1">
            <h3 className="text-base font-cairo font-semibold mb-5 text-foreground">
        ...
        <div className="border-t border-border mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="p-2 bg-background rounded-md border border-border hover:shadow-sm transition-shadow">
